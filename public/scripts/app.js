...
var Student = function (_Person) {
  ...
  _createClass(Student, [{
    ...
    key: 'getDescription',
    value: function getDescription() {
      var descript = _get(Student.prototype.__proto__ || Object.getPrototypeOf(Student.prototype), 'getDescription', this).call(this);
      if (this.hasMajor()) {
        descript = descript + (' Their major is ' + this.major + '.');
      }
    }
  }]);
...
var me = new Traveler('Sean Philippi', 28, 'Austin');
